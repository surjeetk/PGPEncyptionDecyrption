...
import com.pgp.PgpEncryptDescrypt.utils.PgpHelper;
import com.pgp.PgpEncryptDescrypt.utils.RSAKeyPairGenerator;
...
public class TestBCOpenPGP {
	...
	private String id = "surjeet";
	private String passwd = "surjeet";
	private boolean integrityCheck = true;


	private String pubKeyFile = "G:/Workspace/ResearchWorkspace/PgpEncryptDescrypt/src/main/resources/pub.dat";
	private String privKeyFile = "G:/Workspace/ResearchWorkspace/PgpEncryptDescrypt/src/main/resources/secret.dat";

	private String plainTextFile = "G:/Workspace/ResearchWorkspace/PgpEncryptDescrypt/src/main/resources/plain-text.txt"; //create a text file to be encripted, before run the tests
	private String cipherTextFile = "G:/Workspace/ResearchWorkspace/PgpEncryptDescrypt/src/main/resources/cypher-text.dat";
	private String decPlainTextFile = "G:/Workspace/ResearchWorkspace/PgpEncryptDescrypt/src/main/resources/dec-plain-text.txt";
	private String signatureFile = "G:/Workspace/ResearchWorkspace/PgpEncryptDescrypt/src/main/resources/signature.txt";
